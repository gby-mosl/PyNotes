from PySide6.QtWidgets import QWidget, QPushButton, QTextEdit, QListWidget, QGridLayout, QInputDialog, QListWidgetItem
...
class MainWindow(QWidget):
    ...
    def create_note(self):
        title, result = QInputDialog.getText(self, "Ajouter une note", "Titre:")
        if result and title:
